                            ...
                            <div class="box-body">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input id="categoryName" class="form-control " placeholder="请选择" readonly="true" data-toggle="modal" data-target="#modal-default" value="${tbContentCategory.parent.name}"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control required" path="name" placeholder="请输入名称"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input cssClass="form-control required digits" path="sortOrder" placeholder="请输分类排序"/>
                                    </div>
                                </div>
